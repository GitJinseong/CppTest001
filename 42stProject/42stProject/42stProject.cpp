...
//        randomIndex1 = rand() % 4;
//        randomIndex2 = rand() % 4;
//        randomIndex3 = rand() % 13;
//        randomIndex4 = rand() % 13;
//
//        ShuffleNumber(cardPattern[randomIndex1][8], &cardPattern[randomIndex2]);
//        ShuffleNumber(&cardNumber[randomIndex3], &cardNumber[randomIndex4]);
//    }
//
